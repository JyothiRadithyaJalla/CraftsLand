...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#111A15] border-t border-[#1F3025] text-[#FAF9F5] pt-16 pb-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#A3B5A9] text-xs leading-relaxed font-sans pt-2">
            ...
            <p className="text-[#4ADE80] font-serif text-xs font-semibold italic">
          ...
          <div className="space-y-3">
            <h4 className="font-serif text-sm tracking-widest text-[#4ADE80] uppercase font-bold">
              Explore Craftsland
            </h4>
            <ul className="space-y-2 text-xs text-[#A3B5A9] font-sans">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-xs text-[#A3B5A9] font-sans">
              ...
              <li className="flex items-start gap-2 pt-1">
                <Clock className="w-4 h-4 text-[#4ADE80] shrink-0 mt-0.5" />
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-[#A3B5A9] leading-relaxed font-sans">
            ...
            <div className="space-y-2 pt-1">
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-[#19241E] border border-[#273B2F] rounded-xl text-xs text-[#FAF9F5] placeholder-[#A3B5A9]/50 focus:outline-none focus:border-[#4ADE80]"
              />
              <button
                type="button"
                className="w-full py-2.5 bg-[#15803D] hover:bg-[#166534] text-white font-sans font-bold text-xs uppercase tracking-wider rounded-xl transition-colors cursor-pointer border border-[#166534] shadow-xs"
              >
                Join Circle
              </button>
            </div>
        ...
        <div className="mt-14 pt-8 border-t border-[#1F3025] flex flex-col sm:flex-row items-center justify-between text-xs text-[#A3B5A9]">
