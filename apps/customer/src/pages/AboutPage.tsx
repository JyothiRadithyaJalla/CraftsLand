  ...
  return (
    <div className="space-y-24 py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <h1 className="font-serif text-4xl sm:text-6xl font-bold text-[#111A15]">
          Crafted with Passion. Served with Purpose.
        </h1>
        <p className="text-[#5C6E63] text-base font-light leading-relaxed font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 bg-white p-8 sm:p-12 rounded-3xl border border-[#E2E8E0] shadow-sm">
          <h2 className="font-serif text-3xl font-bold text-[#111A15]">The Craftsland Philosophy</h2>
          ...
          <p className="text-[#5C6E63] text-sm leading-relaxed font-sans">
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[#E2E8E0] text-xs text-[#5C6E63]">
            <div className="flex items-center gap-2"><Leaf className="w-4 h-4 text-[#15803D]" /> Farm Sourced</div>
            <div className="flex items-center gap-2"><ChefHat className="w-4 h-4 text-[#15803D]" /> Master Artisans</div>
            <div className="flex items-center gap-2"><Utensils className="w-4 h-4 text-[#15803D]" /> Scratch Kitchen</div>
        ...
        <div
          ...
          className="group relative aspect-[4/3] rounded-3xl overflow-hidden bg-white border border-[#E2E8E0] hover:border-[#15803D]/60 shadow-sm cursor-pointer transition-all duration-500"
        >
          <img
      ...
      <div className="bg-[#F1F7F2] p-8 sm:p-14 rounded-3xl border border-[#E2E8E0] shadow-sm grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
        <div
          data-cursor="image"
          onClick={() => setActiveImage({
          ...
          className="group relative aspect-square rounded-2xl overflow-hidden border border-[#E2E8E0] hover:border-[#15803D]/60 shadow-sm cursor-pointer transition-all duration-500 bg-white"
        >
          <img
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <h2 className="font-serif text-3xl font-bold text-[#111A15]">Master Artisan Mateo Rossi</h2>
          <p className="text-[#37473D] text-sm leading-relaxed font-sans">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            <Link
              to="/menu"
              className="inline-flex items-center gap-2 min-h-[44px] px-6 py-3 rounded-xl bg-[#15803D] hover:bg-[#166534] text-white font-bold text-xs uppercase tracking-wider shadow-sm transition-colors"
            >
              <Utensils className="w-4 h-4" /> Explore the Menu
            </Link>
            <Link
              to="/reservation"
              className="inline-flex items-center gap-2 min-h-[44px] px-6 py-3 rounded-xl border border-[#E2E8E0] text-[#111A15] hover:border-[#15803D] hover:text-[#15803D] bg-white font-semibold text-xs uppercase tracking-wider transition-colors shadow-xs"
            >
