...
export const ForgotPasswordPage: React.FC = () => {
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <MetaTags title="Password Recovery | L'Étoile Noir" />
      <div className="glass-panel p-8 rounded-2xl space-y-6">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4 text-xs">
          <div>
            ...
            <input type="email" required placeholder="guest@letoilenoir.com" className="w-full px-4 py-2.5 bg-[#12141C] border border-[#D4AF37]/20 rounded-lg text-white focus:outline-none focus:border-[#D4AF37]" />
          </div>
