  ...
  return (
    <div className="space-y-0 pb-24 overflow-x-hidden">
          ...
          {pillars.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white p-6 sm:p-8 rounded-2xl border border-[#E2E8E0] hover:border-[#15803D]/50 hover:shadow-sm transition-all duration-300 space-y-4 text-center group shadow-xs"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#15803D]/10 border border-[#15803D]/20 text-[#15803D] flex items-center justify-center mx-auto transition-transform group-hover:scale-110">
                  <Icon className="w-7 h-7" />
                </div>
                <h3 className="font-serif text-lg font-bold text-[#111A15] group-hover:text-[#15803D] transition-colors">
                  {item.title}
                </h3>
                <p className="text-[#5C6E63] text-xs leading-relaxed font-sans">
                  "{item.desc}"
                </p>
              </motion.div>
            );
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 pb-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[#E2E8E0] pb-6">
          <div className="space-y-2">
            <span className="font-sans text-xs font-bold text-[#15803D] tracking-[0.25em] uppercase block">
              Curated Selections
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#111A15]">
              Signature Harvest Dishes
            </h2>
            <p className="text-[#5C6E63] text-sm font-light max-w-xl">
              Watch each dish come alive with cinematic video previews and farm-fresh artistry.
            </p>
          </div>
          <Link
            to="/menu"
            className="inline-flex items-center gap-2 text-xs font-bold text-[#15803D] hover:text-[#166534] uppercase tracking-widest group"
          >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 pb-24">
        <div className="text-center space-y-3">
          ...
          <p className="text-[#5C6E63] text-sm max-w-lg mx-auto font-light">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.map((cat) => (
            <Link
              key={cat.id}
              to={`/menu/${cat.slug}`}
              className="group relative aspect-[3/4] rounded-2xl overflow-hidden bg-[#FAF9F5] border border-[#E2E8E0] hover:border-[#15803D]/60 hover:shadow-md transition-all duration-500 flex flex-col justify-end p-4 text-center shadow-xs"
            >
              <img
              ...
              <div className="relative z-10 space-y-1">
                <h3 className="font-serif text-base font-bold text-white group-hover:text-[#4ADE80] transition-colors">
                  {cat.name}
                </h3>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="bg-[#F1F7F2] p-8 sm:p-16 rounded-3xl border border-[#DFEAE1] shadow-xs grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <span className="font-sans text-xs font-bold text-[#15803D] tracking-[0.3em] uppercase block">
              Our Story
            </span>
            <h2 className="font-serif text-3xl sm:text-5xl font-bold text-[#111A15] leading-tight">
              {RESTAURANT_BRAND.storyHeading}
            </h2>
            <p className="text-[#37473D] text-sm leading-relaxed font-sans">
          ...
          <div className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-[#DFEAE1] shadow-sm">
            <img
            ...
            <div className="absolute bottom-6 left-6 right-6">
              <p className="font-serif text-sm font-bold text-[#FAF9F5] italic">
      ...
      {/* 6. RESERVATION CTA */}
      {/* ========================================================================= */}
      <section className="relative rounded-3xl mx-3 sm:mx-8 overflow-hidden border border-[#166534] shadow-md py-20 px-6 sm:px-12 text-center bg-[#14532D]">
        <div className="absolute inset-0 z-0">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0F3F24]/90 via-[#14532D]/85 to-[#0F3F24]/90" />
        </div>

        <div className="relative z-10 max-w-2xl mx-auto space-y-6">
          <div className="w-12 h-12 rounded-full bg-white/10 border border-white/20 text-[#4ADE80] flex items-center justify-center mx-auto">
            <Calendar className="w-6 h-6" />
          </div>
          <h2 className="font-serif text-4xl sm:text-5xl font-bold text-white">
            Your Table Awaits
          </h2>
          <p className="text-[#E2EAE4] text-sm font-light leading-relaxed font-sans">
          ...
          <div className="pt-4">
            <Link
              to="/reservation"
              className="inline-flex items-center gap-2 px-9 py-4 rounded-xl bg-white hover:bg-[#FAF9F5] text-[#14532D] font-sans font-bold text-xs uppercase tracking-[0.2em] transition-all shadow-md hover:shadow-lg cursor-pointer border border-white min-h-[48px]"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 pt-24">
        <div className="text-center space-y-3">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl font-bold text-[#111A15]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="bg-white p-8 rounded-2xl border border-[#E2E8E0] space-y-4 flex flex-col justify-between shadow-xs hover:border-[#15803D]/40 transition-colors"
            >
              <div className="space-y-3">
                ...
                <p className="text-[#37473D] text-xs leading-relaxed italic font-serif">
                  "{t.review}"
                </p>
              </div>
              <div className="pt-4 border-t border-[#E2E8E0]">
                <h4 className="font-serif font-bold text-sm text-[#111A15]">{t.name}</h4>
                <p className="text-[11px] text-[#15803D] font-sans font-semibold">{t.role}</p>
              </div>
            </div>
          ))}
        </div>
